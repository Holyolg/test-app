		...
		<>
			<WhiteBlock className="px-4 pt-[49px] pb-[92px] ">
				<div className="flex justify-end lg:justify-between">
					...
					<div className="flex flex-col lg:flex-row items-end gap-[30px]">
						<span>
				...
				<div className="text-sm">
					...
					<div className="flex gap-12 lg:justify-center items-center mt-6 snap-x scroll-smooth overflow-x-auto">
						<GrayBlock
							title="Sick"
				...
				<div>
					...
					<div className="flex flex-col lg:flex-row gap-4 lg:justify-between lg:items-center mt-4">
						<div className="flex gap-4">
							<HistoryInput
								className="lg:w-[256px] w-[312px]"
								placeholder="Sick"
							/>
							<HistoryInput
								className="hidden lg:block w-[96px]"
								placeholder="All"
							/>
						</div>
						<div className="flex gap-6">
							<HistoryInput className="w-[112px] lg:hidden" placeholder="All" />
